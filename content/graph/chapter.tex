...
\section{Matching}
	...
	\kactlimport{TurboMatching.h} % potepa
    \kactlimport{BoskiMatching.h} % potepa
	\kactlimport{WeightedMatching.h}
	\kactlimport{GeneralMatching.h}
    \kactlimport{MatroidIntersection.h}

\section{DFS algorithms}
	\kactlimport{Dominators.h} % potepa
	\kactlimport{StronglyConnected.h} % potepa
	\kactlimport{Biconnected.h} % potepa
	\kactlimport{2Sat.h} % potepa
	\kactlimport{EulerWalk.h}
\kactlimport{KthShortest.h} % potepa
